...
export const DEFAULT_SANDBOX_IMAGE = "blockclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "blockclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "blockclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "blockclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "blockclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "blockclaw-sandbox-browser";
