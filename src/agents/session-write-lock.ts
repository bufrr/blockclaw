...
const CLEANUP_STATE_KEY = Symbol.for("blockclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("blockclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("blockclaw.sessionWriteLockWatchdogState");
