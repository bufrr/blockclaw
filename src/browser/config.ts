...
/**
 * Ensure the default "blockclaw" profile exists in the profiles map.
 ...
 *
 * Note: this is an BlockClaw browser profile (routing config), not a Chrome user profile.
...
function ensureDefaultChromeExtensionProfile(
  ...
  // (legacy single-profile configs may use controlPort+1 for blockclaw/blockclaw CDP).
...
export function resolveProfile(
  ...
  let cdpUrl = "";
  const driver = profile.driver === "extension" ? "extension" : "blockclaw";
