...
export const A2UI_PATH = "/__blockclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__blockclaw__/canvas";

export const CANVAS_WS_PATH = "/__blockclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.blockclawCanvasA2UIAction.postMessage(...)
  // - Android: window.blockclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["blockclawCanvasA2UIAction"];
  ...
  globalThis.BlockClaw = globalThis.BlockClaw ?? {};
  globalThis.BlockClaw.postMessage = postToNode;
  globalThis.BlockClaw.sendUserAction = sendUserAction;
  globalThis.blockclawPostMessage = postToNode;
  globalThis.blockclawSendUserAction = sendUserAction;
