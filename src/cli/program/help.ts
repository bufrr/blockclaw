...
const EXAMPLES = [
  ["blockclaw models --help", "Show detailed help for the models command."],
  [
    "blockclaw channels login --verbose",
  ...
  ["blockclaw --dev gateway", "Run a dev Gateway (isolated state/config) on ws://127.0.0.1:19001."],
...
export function configureProgramHelp(program: Command, ctx: ProgramContext) {
  program
    ...
    .option(
      "--dev",
      "Dev profile: isolate state under ~/.blockclaw-dev, default gateway port 19001, and shift derived ports (browser/canvas)",
    )
    .option(
      "--profile <name>",
      "Use a named profile (isolates BLOCKCLAW_STATE_DIR/BLOCKCLAW_CONFIG_PATH under ~/.blockclaw-<name>)",
    )
    .option(
      "--log-level <level>",
