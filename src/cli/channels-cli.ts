    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["blockclaw channels list", "List configured channels and auth profiles."],
          ["blockclaw channels status --probe", "Run channel status checks and probes."],
          [
            "blockclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["blockclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
