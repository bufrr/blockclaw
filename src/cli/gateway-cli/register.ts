      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["blockclaw gateway run", "Run the gateway in the foreground."],
            ["blockclaw gateway status", "Show service status and probe reachability."],
            ["blockclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["blockclaw gateway call health", "Call a gateway RPC method directly."],
