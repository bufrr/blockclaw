...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.OPENCLAW_STATE_DIR = "/tmp/blockclaw-cli-state";
    process.env.OPENCLAW_CONFIG_PATH = "/tmp/blockclaw-cli-state/blockclaw.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        OPENCLAW_STATE_DIR: "/tmp/blockclaw-daemon-state",
        OPENCLAW_CONFIG_PATH: "/tmp/blockclaw-daemon-state/blockclaw.json",
        OPENCLAW_GATEWAY_PORT: "19001",
      },
      sourcePath: "/tmp/ai.blockclaw.gateway.plist",
    });
