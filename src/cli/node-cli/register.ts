    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "blockclaw node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["blockclaw node status", "Check node host service status."],
          ["blockclaw node install", "Install the node host service."],
          ["blockclaw node restart", "Restart the installed node host service."],
