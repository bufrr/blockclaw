    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["blockclaw directory self --channel slack", "Show the connected account identity."],
          [
            'blockclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["blockclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "blockclaw directory groups members --channel discord --group-id <id>",
