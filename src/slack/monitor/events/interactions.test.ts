          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "blockclaw:verify" }],
            },
          ],
        },
      },
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "blockclaw:multi" }],
            },
          ],
        },
      },
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "blockclaw:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "blockclaw:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "blockclaw:datetime" }],
            },
          ],
        },
      },
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "blockclaw:deploy_form",
          root_view_id: "VROOT",
    ...
    expect(payload).toMatchObject({
      ...
      actionId: "view:blockclaw:deploy_form",
      callbackId: "blockclaw:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("captures modal input labels and picker values across block types", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V400",
          callback_id: "blockclaw:routing_form",
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "blockclaw:long_richtext",
