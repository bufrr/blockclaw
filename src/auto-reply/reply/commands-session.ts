...
export const handleRestartCommand: CommandHandler = async (params, allowTextCommands) => {
  ...
  if (hasSigusr1Listener) {
    ...
    return {
      shouldContinue: false,
      reply: {
        text: "⚙️ Restarting BlockClaw in-process (SIGUSR1); back in a few seconds.",
      },
    };
  }
  ...
  return {
    shouldContinue: false,
    reply: {
      text: `⚙️ Restarting BlockClaw via ${restartMethod.method}; give me a few seconds to come back online.`,
    },
  };
};
