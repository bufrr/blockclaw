...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@blockclaw", { botUsername: "blockclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@blockclaw args", {
        botUsername: "blockclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@blockclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "blockclaw" })).toBe(
      "/help@otherbot",
    );
  });
