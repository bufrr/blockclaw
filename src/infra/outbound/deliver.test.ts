...
import { resolvePreferredOpenClawTmpDir } from "../tmp-blockclaw-dir.js";
...
describe("deliverOutboundPayloads", () => {
  ...
  it("includes BlockClaw tmp root in telegram mediaLocalRoots", async () => {
    const sendTelegram = vi.fn().mockResolvedValue({ messageId: "m1", chatId: "c1" });
  ...
  it("includes BlockClaw tmp root in signal mediaLocalRoots", async () => {
  ...
  it("includes BlockClaw tmp root in whatsapp mediaLocalRoots", async () => {
  ...
  it("includes BlockClaw tmp root in imessage mediaLocalRoots", async () => {
