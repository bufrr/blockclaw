...
import { resolveOpenClawPackageRoot, resolveOpenClawPackageRootSync } from "./blockclaw-root.js";
...
export async function resolveControlUiDistIndexPath(
  ...
  // Fallback: traverse up and find package.json with name "blockclaw" + dist/control-ui/index.html
...
export function resolveControlUiRootSync(opts: ControlUiRootResolveOptions = {}): string | null {
  ...
  if (argv1Dir) {
    // blockclaw.mjs or dist/<bundle>.js
