...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">blockclaw devices list</span><br />
          <span class="mono">blockclaw devices approve &lt;requestId&gt;</span>
        </div>
  ...
  const authHint = (() => {
    ...
    if (isAuthRequired) {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">blockclaw dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">blockclaw doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "blockclaw dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.openclaw.ai/web/dashboard"
              ...
              : html`
                <label class="field">
                  ...
                  <input
                    ...
                    placeholder="BLOCKCLAW_GATEWAY_TOKEN"
                  />
                </label>
                <label class="field">
