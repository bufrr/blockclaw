...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.blockclaw/blockclaw.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von blockclaw dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
